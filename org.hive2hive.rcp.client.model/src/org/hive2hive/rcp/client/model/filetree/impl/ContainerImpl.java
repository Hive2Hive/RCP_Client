...
public class ContainerImpl extends TreeElementImpl implements org.hive2hive.rcp.client.model.filetree.Container {
	...
	public EList<TreeElement> getChildren() {
		if (children == null) {
			children = new EObjectContainmentWithInverseEList<TreeElement>(TreeElement.class, this, FileTreePackage.CONTAINER__CHILDREN, FileTreePackage.TREE_ELEMENT__PARENT);
		}
		return children;
	}
