...
import org.hive2hive.rcp.client.model.uimodel.Network;
...
public class UiModelPackageImpl extends EPackageImpl implements UiModelPackage {
	 ...
	 * @see org.hive2hive.rcp.client.model.uimodel.UiModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static UiModelPackage init() {
		...
		FileTreePackage.eINSTANCE.eClass();
	 ...
	 * @generated
	 */
	public EReference getUser_NetworkTree() {
	 ...
	 * @generated
	 */
	public EReference getUser_LocalTree() {
	 ...
	 * @generated
	 */
	public EReference getUiModel_User() {
	 ...
	 * @generated
	 */
	public EReference getUiModel_Network() {
	...
	public void createPackageContents() {
		...
		createEReference(userEClass, USER__NETWORK_TREE);
		createEReference(userEClass, USER__LOCAL_TREE);
		...
		createEReference(uiModelEClass, UI_MODEL__USER);
		createEReference(uiModelEClass, UI_MODEL__NETWORK);
	...
	public void initializePackageContents() {
		...
		FileTreePackage theFileTreePackage = (FileTreePackage)EPackage.Registry.INSTANCE.getEPackage(FileTreePackage.eNS_URI);
		...
		initEReference(getUser_NetworkTree(), theFileTreePackage.getTree(), null, "networkTree", null, 0, 1, User.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUser_LocalTree(), theFileTreePackage.getTree(), null, "localTree", null, 0, 1, User.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getUser_RootDir(), theFileTreePackage.getPath(), "rootDir", null, 0, 1, User.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(uiModelEClass, UiModel.class, "UiModel", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUiModel_User(), this.getUser(), null, "user", null, 0, 1, UiModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUiModel_Network(), this.getNetwork(), null, "network", null, 0, 1, UiModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
